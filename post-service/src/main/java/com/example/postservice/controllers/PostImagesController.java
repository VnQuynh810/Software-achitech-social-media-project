...
public class PostImagesController{
    ...
    @PostMapping("/upload")
    public ResponseEntity<PostImageResponse> upload(@RequestParam("image") MultipartFile file, @RequestParam String postId)
    ...
    public ResponseEntity<?> download(@PathVariable String postId) {
